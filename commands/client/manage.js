  ...
  if (!args[0]) {
    ...
    try {
      ...
      if (state.current_state == "offline") {
        buttons = [
          {
            buttonId: `${prefix}start ${args[0]}`,
            buttonText: { displayText: "Start" },
            type: 1,
          },
          {
            buttonId: `${prefix}restart ${args[0]}`,
            buttonText: { displayText: "Restart" },
            type: 1,
          },
          {
            buttonId: `${prefix}kill ${args[0]}`,
            buttonText: { displayText: "Kill" },
            type: 1,
          },
        ];
      } else if (
